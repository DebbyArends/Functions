...
function compliment() {
  return "Lekker bezig met die functies, Debby"
}

const complimentDebby = compliment()

console.log(complimentDebby)
...
function getDetails() {
  return {firstname: 'Debby' , lastName: 'Arends'}
}
