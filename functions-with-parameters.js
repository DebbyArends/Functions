...
const oneMinute = minutesToSeconds(3)
...
const hocus = merge("Abra", "cadadabra")
console.log(hocus)
...
const baco = calculateDogYears(6)
console.log(baco)
/* Opdracht 5 */
...
function wrapper(character, word, character) {
  return character + word + character
}

const brillemans = wrapper('-',"brillie","-")
console.log(brillemans)
